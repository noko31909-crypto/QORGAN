...
input_folder = ROOT_DIR / "data" / "images" / "Normal" / "Test" / "images"
output_folder = ROOT_DIR / "data" / "images" / "Haar_Compressed" / "Test" / "images"
process_images_in_folder(str(input_folder), str(output_folder))
