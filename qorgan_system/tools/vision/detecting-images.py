...
MODEL_PATH = ROOT_DIR / 'data' / 'runs' / 'detect' / 'Normal_Compressed' / 'weights' / 'best.pt'
...
def detect_objects_in_photo(image_path):
    ...
    result_path = RESULTS_DIR / "teste.jpg"
    cv2.imwrite(str(result_path), image_orig)
...
def detect_objects_in_video(video_path):
    ...
    result_video_path = RESULTS_DIR / "detected_objects_video2.avi"
    out = cv2.VideoWriter(str(result_video_path), fourcc, 20.0, (width, height))
